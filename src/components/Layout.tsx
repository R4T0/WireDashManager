    ...
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="w-full md:w-64 bg-wireguard border-r border-wireguard-muted flex flex-col">
        ...
        <div className="p-4 border-b border-wireguard-muted flex items-center space-x-3">
          <div className="w-8 h-8 rounded-full bg-wireguard-primary/20 flex items-center justify-center text-wireguard-primary teal-glow">
            W
          </div>
          <h1 className="text-lg font-semibold text-wireguard-foreground">WireGuard</h1>
        </div>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <header className="h-16 border-b border-wireguard-muted flex items-center justify-between px-6">
          <h2 className="text-lg font-medium">{navItems.find(item => item.path === location.pathname)?.name || 'WireGuard Manager'}</h2>
